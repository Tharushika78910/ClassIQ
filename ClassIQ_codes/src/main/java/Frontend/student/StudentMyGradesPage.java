...
public class StudentMyGradesPage {
    ...
    public Node getView() {
        ...
        Text t2 = new Text(bundle.getString("teacher.mygrades.criteria.totalmark.bold")); t2.setFont(Font.font("System", FontWeight.BOLD, 14)); t2.setStyle(black);
        Text t3 = new Text(bundle.getString("teacher.mygrades.criteria.part2")); t3.setStyle(black);
        Text t4 = new Text(bundle.getString("teacher.mygrades.criteria.100marks.bold")); t4.setFont(Font.font("System", FontWeight.BOLD, 14)); t4.setStyle(black);
        Text t5 = new Text(bundle.getString("teacher.mygrades.criteria.part3")); t5.setStyle(black);

        Text t7 = new Text(bundle.getString("teacher.mygrades.criteria.assignments.bold")); t7.setFont(Font.font("System", FontWeight.BOLD, 14)); t7.setStyle(black);
        Text t8 = new Text(bundle.getString("teacher.mygrades.criteria.part4")); t8.setStyle(black);
        Text t9 = new Text(bundle.getString("teacher.mygrades.criteria.20marks.bold")); t9.setFont(Font.font("System", FontWeight.BOLD, 14)); t9.setStyle(black);
        Text t10 = new Text(bundle.getString("teacher.mygrades.criteria.part5")); t10.setStyle(black);

        Text t11 = new Text(bundle.getString("teacher.mygrades.criteria.project.bold")); t11.setFont(Font.font("System", FontWeight.BOLD, 14)); t11.setStyle(black);
        Text t12 = new Text(bundle.getString("teacher.mygrades.criteria.part6")); t12.setStyle(black);
        Text t13 = new Text(bundle.getString("teacher.mygrades.criteria.30marks.bold")); t13.setFont(Font.font("System", FontWeight.BOLD, 14)); t13.setStyle(black);
        Text t14 = new Text(bundle.getString("teacher.mygrades.criteria.part7")); t14.setStyle(black);

        Text t15 = new Text(bundle.getString("teacher.mygrades.criteria.finalexam.bold")); t15.setFont(Font.font("System", FontWeight.BOLD, 14)); t15.setStyle(black);
        Text t16 = new Text(bundle.getString("teacher.mygrades.criteria.part8")); t16.setStyle(black);
        Text t17 = new Text(bundle.getString("teacher.mygrades.criteria.50marks.bold")); t17.setFont(Font.font("System", FontWeight.BOLD, 14)); t17.setStyle(black);
