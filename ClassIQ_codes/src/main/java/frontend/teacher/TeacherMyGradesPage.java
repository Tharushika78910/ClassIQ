...
public class TeacherMyGradesPage {
    ...
    public TeacherMyGradesPage() {
        this(Session.getCurrentLocale() != null ? Session.getCurrentLocale() : DEFAULT_LOCALE);
    }
    ...
    public Node getView() {
        ...
        r1a.setStyle(labelStyle);
        r1b.setStyle(labelStyle);
        r2a.setStyle(labelStyle);
        r2b.setStyle(labelStyle);
        r3a.setStyle(labelStyle);
        r3b.setStyle(labelStyle);
        r4a.setStyle(labelStyle);
        r4b.setStyle(labelStyle);
        r5a.setStyle(labelStyle);
        r5b.setStyle(labelStyle);

        if (rtl) {
            gradeTable.add(r1b, 0, 0);
            gradeTable.add(r1a, 1, 0);
            gradeTable.add(r2b, 0, 1);
            gradeTable.add(r2a, 1, 1);
            gradeTable.add(r3b, 0, 2);
            gradeTable.add(r3a, 1, 2);
            gradeTable.add(r4b, 0, 3);
            gradeTable.add(r4a, 1, 3);
            gradeTable.add(r5b, 0, 4);
            gradeTable.add(r5a, 1, 4);
        } else {
            gradeTable.add(r1a, 0, 0);
            gradeTable.add(r1b, 1, 0);
            gradeTable.add(r2a, 0, 1);
            gradeTable.add(r2b, 1, 1);
            gradeTable.add(r3a, 0, 2);
            gradeTable.add(r3b, 1, 2);
            gradeTable.add(r4a, 0, 3);
            gradeTable.add(r4b, 1, 3);
            gradeTable.add(r5a, 0, 4);
            gradeTable.add(r5b, 1, 4);
        }
        ...
        scroll.setStyle(TRANSPARENT_STYLE);
        ...
        page.setStyle(TRANSPARENT_STYLE);

        StackPane root = new StackPane(page);
        root.setPadding(new Insets(10));
        root.setStyle(TRANSPARENT_STYLE);
